...
import { IoIosBasket, IoIosContacts } from 'react-icons/io'
      ...
      <BoxWrapper>
        ...
        <div className='pl-4'>
            ...
            <div className='flex items-center'>
                <strong className='text-xl text-gray-700 font-semibold'>LKR 200 000.00</strong>
      ...
      <BoxWrapper>
        ...
        <div className='pl-4'>
            ...
            <div className='flex items-center'>
                ...
                <span className='text-sm text-green-500 pl-2'>+420</span>
            </div>
        </div>
      </BoxWrapper>
      <BoxWrapper>
        <div className='rounded-full h-12 w-12 flex items-center justify-center bg-violet-500'>
            <IoIosBasket className='text-2xl text-white' />
        </div>
        <div className='pl-4'>
