        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-center">
            <ul className="flex items-center gap-5">
              <li>
                <a href="#" className="text-white flex items-center gap-2 hover:text-green-500 transition-colors">
            ...
            <ul className="flex items-center gap-5">
              <li>
                <a href="#" className="text-white text-xs font-semibold uppercase px-5 py-1.5 border border-green-500 rounded-full hover:bg-green-500 transition-colors">
                  How to bid
                </a>
              </li>
              <li>
      ...
      <header className="flex items-center justify-between flex-nowrap mx-5">
        <div className="flex items-center justify-between gap-20">
          ...
          <nav className="hidden lg:block">
            <ul className="flex">
              <li className="px-6">
                <a href="#" className="text-white font-semibold text-base py-6 block hover:text-green-500 transition-colors">
                  Home
                </a>
              </li>
              <li className="px-6">
        ...
        <div className="flex items-center justify-end gap-8">
          ...
          {isLoggedIn ? (
            ...
            <>
              <a href="/signup" className="hidden lg:inline-block text-green-500 bg-white hover:bg-gray-100 transition-colors font-semibold py-2 px-4 rounded">
                Signup
              </a>
              <a href="/login" className="hidden lg:inline-block text-white bg-green-500 hover:bg-green-600 transition-colors font-semibold py-2 px-4 rounded">
                Login
              </a>
            </>
          )}
